...
public class VeiculoController {
    ...
    public VeiculoModel cadastrar(@Valid @RequestBody VeiculoInput veiculoInput) {
        ...
        Veiculo veiculo = registroVeiculoService.cadastrar(novoVeiculo);

        return veiculoAssembler.toModel(veiculo);
    }
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void liberarVeiculo(@PathVariable Long veiculoId) {
